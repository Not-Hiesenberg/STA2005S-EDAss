...
kable_styling(position = "center", latex_options="hold_position")
```
Where A,B, and C correspond to the treatment of no oil, coconut oil and castor oil respectively.

\todo{generate randomisatoin and give in appendix}

# Data Collection
Dhiya do the justifications of assumptions here
```{r}
...
keeran issues we ran into number of replications 
...
# Appendix 
when you talk about data gen include analysis of n pilot data
```{r}
#| eval: false
#Generation of data
